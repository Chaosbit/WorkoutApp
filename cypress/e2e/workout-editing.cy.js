describe('Workout Editing', () => {
  ...
  describe('Saving Changes', () => {
    ...
    it('should successfully save workout name changes', () => {
      ...
      // Should show success message using the new messaging system
...
## Jumping Jacks - 1:00`
  ...
  describe('Validation and Error Handling', () => {
    ...
    it('should prevent saving with empty workout name', () => {
      ...
      // Should show validation error using the new messaging system
      cy.get('.app-message').should('be.visible')
      cy.get('.app-message__text').should('contain', 'Workout name must be at least 3 characters')
    ...
    it('should prevent saving with empty workout content', () => {
      ...
      // Should show validation error using the new messaging system
      cy.get('.app-message').should('be.visible')
      cy.get('.app-message__text').should('contain', 'Workout must contain at least one exercise')
    ...
    it('should handle markdown parsing errors gracefully', () => {
      ...
      // Should show parsing error using the new messaging system
      cy.get('.app-message').should('be.visible')
      cy.get('.app-message__text').should('contain', 'Error parsing workout content')
